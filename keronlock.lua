...
local Script = {
    Name = "Keron" --\\ This is used for notification.
}
local Misc = {
...
watermark_module.name = "Keron Rewrite"
...
local script_info = loadstring(game:HttpGet("https://pastebin.com/raw/eXcuD0Zn"))()
...
local lib = actualLib:Load({name = "Keron Rewrite", sizeX = 425, sizeY = 510, color = Color3.fromRGB(37, 15, 134)})
-- \\ T510
...
Info:Label("Script: Keron Rewrite")
